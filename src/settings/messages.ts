...
export const MESSAGE_START = (isActiveInitialSub: boolean) =>
  `Здравствуйте! Я бот для поиска квартир в аренду на длительный срок. \n\nКак я работаю: \n\n - 24/7 анализирую сдающиеся квартиры на Авито; \n - Обновляю базу 1 раз в минуту \n - Даю возможность настроить уведомления о новых объявлениях под себя с помощью фильтров прямо внутри бота \n - Присылаю ссылки на подходящие вам квартиры сразу после публикации объявления 🔥${
    isActiveInitialSub
      ? '\n\nАктивировал вам бесплатный пробный период на 1 день 🎁'
      : ''
  }`;
...
export const MESSAGE_INITIAL_SUBSCRIPTION_SUCCESS =
  'Активирован пробный период на 1 день';
